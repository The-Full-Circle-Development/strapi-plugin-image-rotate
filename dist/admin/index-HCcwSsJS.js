...
const PluginIcon = (props) => /* @__PURE__ */ jsxRuntime.jsxs("svg", { width: "1em", height: "1em", viewBox: "0 0 24 24", fill: "none", "aria-hidden": true, focusable: "false", ...props, children: [
  /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "3", y: "3", width: "18", height: "18", rx: "2", stroke: "currentColor", strokeWidth: "2" }),
  /* @__PURE__ */ jsxRuntime.jsx("circle", { cx: "8.5", cy: "8.5", r: "1.5", fill: "currentColor" }),
  /* @__PURE__ */ jsxRuntime.jsx("path", { d: "m21 15-5-5L5 21", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" })
] });
...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => Promise.resolve().then(() => require("./App-sWIpg9wd.js")),
      permissions: []
    });
    app.registerPlugin({
      id: PLUGIN_ID,
...
exports.RotateActions = RotateActions;
exports.bustCache = bustCache;
exports.index = index;
exports.isRotatableImage = isRotatableImage;
